module.exports = {
    ...
    themeConfig: {
        ...
        sidebar: {
            '/study/java/': getJavaSidebar("Java","More"),
            '/study/docker/': getDockerSidebar("Docker","More"),
            '/study/javascript/': getJavascriptSidebar("Javascript","More"),
            '/study/linux/': getLinuxSidebar("Linux","More"),
            '/study/springboot/': getSBSidebar("Spring","More"),
            '/study/springcloud/': getSCSidebar("SpringCloud","More"),
            '/study/vue/': getVueSidebar("Vue","More"),
            '/study/other/': getOtherSidebar("Other","More"),
            '/favorite/': ['']
        },
        base: '/',
